        ...
        <div className="bg-gradient-to-r from-[#4c51bf] to-[#6b46c1] px-6 py-8 sm:px-10 sm:py-12">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h2 className="text-2xl font-bold text-white">Kaushal</h2>
        ...
        <div className="px-6 py-8 sm:px-10 sm:py-12 grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="space-y-6">
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-1">
                ...
                <Input disabled id="name" value="Kaushal" />
              </div>
              <div className="space-y-1">
            ...
            <div className="space-y-1">
              ...
              <Input disabled id="email" value="kaushal@email" />
            </div>
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-1">
                <Label htmlFor="parent-name">Parent&apos;s Name</Label>
                <Input disabled id="email" value="Satoru Gojo" />
              </div>
              <div className="space-y-1">
                <Label htmlFor="parent-name">Parent&apos;s email</Label>
                <Input disabled id="email" value="gojo@email" />
              </div>
            </div>
            <div className="space-y-1">
          ...
          <div className="space-y-6">
            <div className="bg-gray-100 dark:bg-gray-800 rounded-lg p-6 space-y-4">
              <h3 className="text-lg font-bold">Under-18 Rank</h3>
              <div className="flex items-center justify-between">
                <div className="text-4xl font-bold text-[#4c51bf]">7</div>
              </div>
              <div className="relative w-full h-4 bg-gray-200 dark:bg-gray-700 rounded-full">
                <div className="absolute left-0 top-0 h-full w-[90%] bg-gradient-to-r from-[#4c51bf] to-[#6b46c1] rounded-full" />
              </div>
            </div>
            <div className="bg-gray-100 dark:bg-gray-800 rounded-lg p-6 space-y-4">
