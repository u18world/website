        ...
        <div className="bg-gradient-to-r from-[#4c51bf] to-[#6b46c1] px-6 py-8 sm:px-10 sm:py-12">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h2 className="text-2xl font-bold text-white">Mahesh Babu</h2>
          ...
          <div className="space-y-6">
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-1">
                ...
                <Input disabled id="name" value="Mahesh Babu" />
              </div>
              <div className="space-y-1">
                <Label htmlFor="phone">Phone</Label>
                <Input disabled id="phone" value="+1 (123) 456-7890" />
              </div>
            </div>
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-1">
            ...
            <div className="bg-gray-100 dark:bg-gray-800 rounded-lg p-6 space-y-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="text-gray-500 dark:text-gray-400">
                  Current Status: Under-18 Champion
                </div>
              </div>
